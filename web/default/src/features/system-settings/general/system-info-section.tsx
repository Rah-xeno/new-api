...
const _systemInfoSchema = z.object({
  ...
  GlobalSystemPromptAppend: z.string().optional(),
  legal: z.object({
...
export function SystemInfoSection({ defaultValues }: SystemInfoSectionProps) {
  ...
  const normalizedDefaults: SystemInfoFormValues = {
    ...
    GlobalSystemPromptAppend: normalizeValue(
      defaultValues.GlobalSystemPromptAppend
    ),
    legal: {
          ...
          <SettingsForm onSubmit={handleSubmit}>
            ...
            <SettingsFormGrid>
              ...
              <SettingsFormGridItem span='full'>
                <FormField
                  control={form.control}
                  name='GlobalSystemPromptAppend'
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('Global System Prompt')}</FormLabel>
                      <FormControl>
                        <Textarea rows={12} {...field} />
                      </FormControl>
                      <FormDescription>
                        {t(
                          'Prepended to relay system prompts for all groups except those configured as exempt.'
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
