    ...
    <div className='flex min-h-0 flex-1 flex-col gap-6 overflow-y-auto p-6'>
      <div>
        ...
        <p className='text-muted-foreground text-sm'>
          {t(
            'Invite friends and earn rewards when they top up or redeem codes.'
          )}
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className='flex flex-wrap items-center gap-4'>
          <code className='bg-muted rounded-md px-4 py-2 font-mono text-lg'>
            {d.aff_code}
          </code>
        ...
        <Card>
          <CardContent className='flex items-center gap-3 pt-6'>
            ...
            <div>
              ...
              <div className='text-2xl font-bold'>
                {formatQuota(d.aff_history_quota)}
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='flex flex-wrap gap-3'>
              {d.benefits.map((b) => {
                let triggerLabel = b.trigger_type
                if (b.trigger_type === 'redemption') {
                  triggerLabel = t('Redemption')
                } else if (b.trigger_type === 'topup') {
                  triggerLabel = t('Top-up')
                }
                  ...
                  <Card key={b.id} className='min-w-[200px] flex-1'>
                    <CardContent className='pt-4'>
                      ...
                      <div className='mt-2 flex flex-wrap gap-1'>
                        ...
                        {b.effective_days > 0 && (
                          <Badge variant='outline'>{b.effective_days}d</Badge>
                        )}
                      </div>
                    </CardContent>
                  </Card>
